...
internal class AssigneeTemplateAddedForExistingStepQuery : ICustomization
{
                            ...
                            fixture.Build<ApprovalStep>()
                                ...
                                .With(
                                    s => s.AssigneeTemplates, new []
                                    {
                                        ...
                                        fixture
                                            .Build<AssigneeTemplate>()
                                            .With(x => x.AssigneeId, TestAssigneeTemplates.AssigneeTemplateForUserTwoAssigneeId)
                                            .With(x => x.Type, TestAssigneeTemplates.AssigneeTemplateForUserTwoAssigneeType)
                                            .Create(),
                                        fixture
                                            .Build<AssigneeTemplate>()
                                            .With(x => x.AssigneeId, TestAssigneeTemplates.AssigneeTemplateForUserThreeAssigneeId)
                                            .With(x => x.Type, TestAssigneeTemplates.AssigneeTemplateForUserThreeAssigneeType)
                                            .Create()
                                    }
                                )
                            .Create()
