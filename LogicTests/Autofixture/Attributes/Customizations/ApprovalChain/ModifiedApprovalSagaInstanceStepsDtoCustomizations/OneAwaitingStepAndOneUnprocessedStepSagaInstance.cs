...
public class OneAwaitingStepAndOneUnprocessedStepSagaInstance : ICustomization
{
    public void Customize(IFixture fixture)
    {
        fixture.Customize<ModifiedApprovalSagaInstanceDto>(f => f
            .With(s => s.UserId, TestUserIds.UserOne)
            .With(s => s.CurrentStepIndex, 0)
            .With(s => s.Steps, new[]
            {
                fixture.Build<ApprovalStepDto>()
                    ...
                    .With(q => q.CustomActionTemplateAtStartId, (int?)null)
                    .With(q => q.CustomActionTemplateBeforeEndId, (int?)null)
                    .With(q => q.Message, (string?)null)
                    .With(
                        s => s.Assignees, new []
                        {
                            fixture
                ...
                fixture.Build<ApprovalStepDto>()
                    ...
                    .With(q => q.CustomActionTemplateBeforeEndId, (int?)null)
                    .With(q => q.Message, (string?)null)
                    .With(q => q.CanBeRejected, false)
                    .With(q => q.CanBeSentToReview, false)
                    .With(q => q.CanAttachDocuments, false)
                    .With(
                        s => s.Assignees, new []
                        {
                            fixture
